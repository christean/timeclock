...
?>
    <div class="log">
      <div class="tamForm">
      <form class="contact_form" id="frmLogin" method="POST" action="val-log-sup.php">
      <fieldset>
      <legend class="textLog">LOGIN Supervisor</legend>  
      ...
      <input type="hidden" value="2" name="log">
      </div>
    
      <button type="buttom" class="btn btn-default">Entrar</button>  <button type="reset" class="btn btn-default">Borrar</button>
      </fieldset>
      </form>
      </div>
    </div>
